...
[![Workflow Status](https://img.shields.io/github/actions/workflow/status/Numbersf/Action-Build/Build%20Kernel%20OnePlus.yml?branch=KernelSU&label=Build&logo=github-actions&style=flat-square)](https://github.com/Numbersf/Action-Build/actions/workflows/Build%20Kernel%20OnePlus.yml?query=branch%3AKernelSU)
...
<p>
  <img src="https://github.com/Numbersf/Action-Build/blob/KernelSU/pic/start.gif" width="500"/>
  <img src="https://github.com/Numbersf/Action-Build/blob/KernelSU/pic/start(2).png" width="500"/>
</p>
...
<p>
  <img src="https://github.com/Numbersf/Action-Build/blob/KernelSU/pic/syncfork.png" width="500"/>
</p>
...
```
Set Branch: Divided into manager-layer and built-in-layer. Please modify according to the channel name in the KernelSU repository. Do not modify unless you are a developer. Do not leave it empty or remove it.
...
```
AnyKernel3_KernelSU_34895_OnePlusAce2Pro_Android16.0.0(5.15.180)_KPM_BBG_ILH_DS_REKER.zip
AnyKernel3_KernelSU_34895_OnePlus11_Android14.1.0(5.15.123)_KPM_BBG_ILH_DS_REKER.zip
AnyKernel3_KernelSU_34895_OnePlus15(AOSP)_Android16.0.0(6.12.23)_KPM_BBG_ILH_DS_REKER.zip
```  
